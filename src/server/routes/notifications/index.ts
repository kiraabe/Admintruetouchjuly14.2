...
router.post('/seed', async (req: Request, res: Response) => {
  try {
    // Delete existing notifications first (optional - remove for production)
    ...
    for (const notification of seedData) {
      ...
      `, [notification.target, notification.description, notification.type, notification.status, notification.location, notification.location_label])
    }
